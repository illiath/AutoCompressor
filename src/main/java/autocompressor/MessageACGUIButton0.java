...
public class MessageACGUIButton0 implements IMessage {
	public int	x;
	public int	y;
	public int	z;

	public MessageACGUIButton0() {
	}

	public MessageACGUIButton0(TileEntityAutoCompressor tileEntityAC) {
	...
	public static class Handler implements IMessageHandler<MessageACGUIButton0, IMessage> {
		/**
		 * This gets called when the packet is read and received.
		 */
		@Override
		public IMessage onMessage(MessageACGUIButton0 message, MessageContext ctx) {
