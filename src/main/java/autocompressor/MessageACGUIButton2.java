...
public class MessageACGUIButton2 implements IMessage{
	public int	x;
	public int	y;
	public int	z;

	public MessageACGUIButton2() {
	}

	public MessageACGUIButton2(TileEntityAutoCompressor tileEntityAC) {
	...
	public static class Handler implements IMessageHandler<MessageACGUIButton2, IMessage> {
		/**
		 * This gets called when the packet is read and received.
		 */
		@Override
		public IMessage onMessage(MessageACGUIButton2 message, MessageContext ctx) {
