...
public class MessageACGUIButton3 implements IMessage {
	public int	x;
	public int	y;
	public int	z;

	public MessageACGUIButton3() {
	}

	public MessageACGUIButton3(TileEntityAutoCompressor tileEntityAC) {
	...
	public static class Handler implements IMessageHandler<MessageACGUIButton3, IMessage> {
		/**
		 * This gets called when the packet is read and received.
		 */
		@Override
		public IMessage onMessage(MessageACGUIButton3 message, MessageContext ctx) {
